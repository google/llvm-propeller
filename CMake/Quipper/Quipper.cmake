...
# LINT.ThenChange(../../WORKSPACE.bzlmod:quipper_commit_hash)

set(propeller_quipper_build_dir ${CMAKE_BINARY_DIR}/quipper-build)
set(propeller_quipper_download_url https://github.com/google/perf_data_converter/${_QUIPPER_HASH}.tar.gz)
...
include_directories(${propeller_quipper_src_dir}/src ${propeller_quipper_src_dir}/src/quipper ${propeller_quipper_build_dir}/src/quipper)
