...
#ifndef PROPELLER_PERFDATA_READER_H_
#define PROPELLER_PERFDATA_READER_H_
...
struct MMapEntry {
  ...
  std::string DebugString() const {
    return llvm::formatv("[{0}, {1}](pgoff={2}, size={3}, fn='{4}')", load_addr,
                         load_addr + load_size, page_offset, load_size,
                         file_name)
        .str();
  }
};
...
#endif  // PROPELLER_PERFDATA_READER_H_
