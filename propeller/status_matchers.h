...
#ifndef PROPELLER_STATUS_MATCHERS_H_
#define PROPELLER_STATUS_MATCHERS_H_
...
#define RET_CHECK_OK(status)                                                   \
  do {                                                                         \
    const ::absl::Status _status =                                             \
        ::llvm_propeller::internal_status::GetStatus(status);                  \
    if (!_status.ok()) {                                                       \
...
#endif  // PROPELLER_STATUS_MATCHERS_H_
