...
; LINUX-SECTIONS1-LABEL:	alal.BB.main:
; LINUX-SECTIONS1-NOT: 		.section
; LINUX-SECTIONS1-LABEL:	aalal.BB.main:
; LINUX-SECTIONS1-NOT: 		.section
; LINUX-SECTIONS1-LABEL:	aaalal.BB.main:
...
; LINUX-SECTIONS1-NOT: 		.section
; LINUX-SECTIONS1-LABEL:	lal.BB.main:
; LINUX-SECTIONS1-NOT:		.section
; LINUX-SECTIONS1:		.section	.text.main,"ax",@progbits
...
; LINUX-SECTIONS2-LABEL:	alal.BB.main:
; LINUX-SECTIONS2-NOT: 		.section
; LINUX-SECTIONS2-LABEL:	aalal.BB.main:
; LINUX-SECTIONS2-NOT: 		.section
; LINUX-SECTIONS2-LABEL:	aaalal.BB.main:
; LINUX-SECTIONS2: 		.section	.text.main,"ax",@progbits,unique,1
; LINUX-SECTIONS2-LABEL: 	l.BB.main:
; LINUX-SECTIONS2-NOT: 		.section
; LINUX-SECTIONS2-LABEL:	al.BB.main:
; LINUX-SECTIONS2-NOT: 		.section
; LINUX-SECTIONS2-LABEL:	lal.BB.main:
; LINUX-SECTIONS2:		.section	.text.main,"ax",@progbits
