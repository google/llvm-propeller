...
# RUN: ld.lld  %t.o -propeller=%t_prof.propeller --verbose -propeller-keep-named-symbols -o %t.propeller.reorder.out
...
# REORDER-NEXT:	jmp	-35 <aaa.BB.bar>
# REORDER-NEXT: int3
# REORDER-EMPTY:
# REORDER-NEXT:	baz:
...
# RUN: ld.lld  %t.o -propeller=%t_prof.propeller -propeller-opt=no-reorder-blocks -propeller-keep-named-symbols -o %t.propeller.noreorderblocks.out  2>&1 | FileCheck %s --check-prefixes=WARN,IMPLICITNOSPLIT
# WARN-NOT:		warning:
...
# NO_REORDER_BB-NEXT:	je	12 <aa.BB.bar>
# NO_REORDER_BB-EMPTY:
...
# RUN: ld.lld  %t.o -propeller=%t_prof.propeller -propeller-opt=no-reorder-funcs -propeller-keep-named-symbols -o %t.propeller.noreorderfuncs.out
...
# NO_REORDER_FUNC-NEXT:	jmp	-27 <aaa.BB.bar>
# NO_REORDER_FUNC-NEXT:	int3
# NO_REORDER_FUNC-EMPTY:
...
# RUN: ld.lld  %t.o -propeller=%t_prof.propeller -propeller-opt=no-split-funcs -propeller-keep-named-symbols -o %t.propeller.nosplitfuncs.out
...
# NO_SPLIT_FUNC-NEXT:	jmp	-19 <aaa.BB.bar>
...
# RUN: ld.lld  %t.o -propeller=%t_prof.propeller -propeller-opt=no-split-funcs -propeller-opt=no-reorder-funcs -propeller-keep-named-symbols -o %t.propeller.nosplitreorderfuncs.out
...
# NO_SPLIT_REORDER_FUNC-NEXT:	jmp	-19 <aaa.BB.bar>
# NO_SPLIT_REORDER_FUNC-NEXT:	int3
# NO_SPLIT_REORDER_FUNC-EMPTY:
