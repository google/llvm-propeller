...
StringRef CodeGenModule::getMangledName(GlobalDecl GD) {
  ...
  // With BasicBlockSections, it is important to have a unique name for static
  // functions, to differentiate the sections.
  /*if (getCodeGenOpts().BasicBlockSections != "none" &&
    ...
    std::string UniqueSuffix = getUniqueModuleId(&getModule());
    if (UniqueSuffix != "")
      MangledName = MangledName + '.' + UniqueSuffix;
    else
      MangledName = MangledName + ".module." + getModule().getModuleIdentifier();
  }*/
