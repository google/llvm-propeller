...
# CHECK:	0000000000201000 _foo1:
# CHECK-NEXT:   nop
# CHECK-NEXT:   nopl	(%rax)
# CHECK-EMPTY:
# CHECK-NEXT:	0000000000201008 _foo2:
# CHECK-NEXT:	nop
# CHECK-NEXT:	nop
# CHECK-NEXT:	nopw	(%rax,%rax)
# CHECK-EMPTY:
# CHECK-NEXT:	0000000000201010 _foo3:
# CHECK-NEXT:	nop
# CHECK-NEXT:	nop
# CHECK-NEXT:	nop
# CHECK-NEXT:	nopw	(%rax,%rax)
...
# CHECK-NEXT:	int3
# CHECK-EMPTY:
# CHECK-NEXT:	0000000000201044 _foo6:
# CHECK-NEXT:	retq
# CHECK-NEXT:	int3
# CHECK-NEXT:	int3
# CHECK-NEXT:	int3
# CHECK-EMPTY:
# CHECK-NEXT:	0000000000201048 _foo7:
